      ...
      <div className="space-y-4">
        <div className="grid md:grid-cols-2 gap-4">
          <FormField
            ...
            onChange={(value) => setFormData({ ...formData, itemNumber: value as string })}
        ...
        <div className="grid md:grid-cols-2 gap-4">
          <FormField
            ...
            type="text"
            value={formData.gtin}
            onChange={(value) => setFormData({ ...formData, gtin: value as string })}
          ...
          <FormField
            ...
            type="text"
            value={formData.upc}
            onChange={(value) => setFormData({ ...formData, upc: value as string })}
        ...
        <div className="grid md:grid-cols-3 gap-4">
          <FormField
            ...
            onChange={(value) => setFormData({ ...formData, unitOfMeasure: value as string })}
            required
            options={UNITS}
          />
          ...
          <FormField
            ...
            onChange={(value) => setFormData({ ...formData, parLevel: Number(value) })}
            required
          ...
          <FormField
            ...
            onChange={(value) => setFormData({ ...formData, binSize: Number(value) })}
            required
          ...
          <div className="border border-gray-200 rounded-lg p-3">
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                <p className="text-sm text-gray-600 break-all">{formData.imageUrl}</p>
                <a
                  href={formData.imageUrl}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-xs text-brand-accentblue hover:underline flex items-center gap-1 mt-1"
                >
                  Open in new tab
